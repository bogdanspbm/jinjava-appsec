...
public class RejectAttrFilter implements Filter {
   ...
   public Object filter(Object var, JinjavaInterpreter interpreter, String... args) {
      ...
      if (args.length == 0) {
         throw new InterpretException(this.getName() + " filter requires an attr to filter on", interpreter.getLineNumber());
      } else {
         ...
         if (args.length > 2) {
            expArgs = (String[])Arrays.copyOfRange(args, 2, args.length);
         }
